    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="card m-4">
                    <h5 class="card-header">Kategori Buku</h5>
                    <a href="proses/kategoribuku/tambah_kategori.php" class="btn btn-primary mb-4 col-2 m-4">Tambah
                        Kategori</a>
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                while ($d = mysqli_fetch_array($data)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="proses/kategoribuku/edit_kategori.php?KategoriID=<?php echo $d['KategoriID']; ?>"
                                                class="btn btn-info btn-sm mb-3"><i class="bx bx-edit"></i></a>
                                            <a href="proses/kategoribuku/hapus_kategori.php?KategoriID=<?php echo $d['KategoriID']; ?>"
                                                class="btn btn-warning btn-sm mb-3"><i class="bx bx-trash"></i></a>
