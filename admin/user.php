        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="card m-4">
                    ...
                    <a href="proses/user/tambah_user.php" class="btn btn-primary mb-4 col-2 m-4">Tambah
                        User</a>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                include '../koneksi.php';
                                $no = 1;
                                $query = "SELECT * FROM user WHERE Level IN ('petugas', 'peminjam')";
                                ...
                                if ($result = $koneksi->query($query)) {
                                    while ($k = $result->fetch_assoc()) {
                                        if ($k['Level'] != 'admin') {
                                            ...
                                            echo "<td>" . $k['Level'] . "</td>";
                                            echo "<td>
                                                <a href='proses/user/edit_user.php?UserID={$k['UserID']}' 
                                                    class='btn btn-info btn-sm mb-3'><i class='bx bx-edit'></i></a>
                                                <a href='proses/user/hapus_user.php?UserID={$k['UserID']}' 
