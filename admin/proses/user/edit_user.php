    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                $dimas = mysqli_query($koneksi, "SELECT * FROM user WHERE UserID='$UserID'");
                while ($madis = mysqli_fetch_array($dimas)) {
                    ...
                    <div class="card m-4">
                        ...
                        <form action="proses_edit_user.php" method="post" enctype="multipart/form-data">
                            <div class="mb-3 m-4">
                                <input type="hidden" name="UserID" value="<?php echo $madis['UserID']; ?>">
                                <div>
                                    <label for="Username" class="form-label">Username</label>
                                    <input type="text" class="form-control" name="Username" id="Username"
                                        placeholder="Masukkan Username" value="<?php echo $madis['Username']; ?>" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" class="form-control" name="Email" id="Email"
                                        placeholder="Masukkan Email" value="<?php echo $madis['Email']; ?>" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="NamaLengkap" id="NamaLengkap"
                                        placeholder="Masukkan Nama Lengkap" value="<?php echo $madis['NamaLengkap']; ?>"
                                        required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="Alamat" id="Alamat"
                                        placeholder="Masukkan Alamat" value="<?php echo $madis['Alamat']; ?>" required>
                                </div>

                                <div>
                                    <label for="Level" class="form-label">Pilih Level</label>
                                    <select class="form-select" name="Level" id="Level" required>
                                        <option value="petugas" <?php echo ($level == 'petugas') ? 'selected' : ''; ?>>Petugas
                                        </option>
                                        <option value="peminjam" <?php echo ($level == 'peminjam') ? 'selected' : ''; ?>>
                                            Peminjam</option>
                                    </select>
                                </div>
                        ...
                        <a href="../../user.php" type="submit" class="btn btn-info">Kembali</a>
                    </form>
                </div>
