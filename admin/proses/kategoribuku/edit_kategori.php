    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                while ($madis = mysqli_fetch_array($data)) {
                    ?>
                    <div class="card m-4">
                        <h5 class="card-header">Edit Kategori</h5>
                        <form action="proses_ubah_kategori.php" method="post">
                            <div class="mb-3 m-4">
                                <label for="NamaKategori" class="form-label">Edit Kategori</label>
                                <input type="hidden" name="KategoriID" value="<?php echo $madis['KategoriID']; ?>">
                                <input type="text" class="form-control" value="<?php echo $madis['NamaKategori']; ?>"
                                    name="NamaKategori" id="NamaKategori" placeholder="Masukkan Nama Kategori" required>
                            </div>
                            <button type="submit" class="btn btn-success m-4">Simpan</button>
                            <a href="../../kategoribuku.php" type="submit" class="btn btn-info">Kembali</a>
                        </form>
                    </div>
                <?php } ?>
